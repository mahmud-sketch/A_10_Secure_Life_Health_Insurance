        ...
        <div>
            ...
            <div className="carousel relative rounded relative overflow-hidden shadow-xl">
                <div className="carousel-inner relative overflow-hidden w-full">
                    ...
                    <div className="carousel-item absolute opacity-0 bg-center" style={{ "height": "500px", "backgroundImage": "url(https://i.ibb.co/pK9DbKC/Health-insurance-min-1.jpg)" }}>
                    ...
                    <div className="carousel-item absolute opacity-0 bg-center" style={{ "height": "500px", "backgroundImage": "url(https://i.ibb.co/FWnbfHk/graphic-2-new-our-healthcare-insurance-services-848x477-2020-06-30-17-39-59.jpg)" }}>
                    </div>
                    ...
                    <div className="carousel-item absolute opacity-0" style={{ "height": "500px", "backgroundImage": "url(https://i.ibb.co/KwWBc9X/h2.jpg)" }}>
                    </div>
                    <label htmlFor="carousel-2"
